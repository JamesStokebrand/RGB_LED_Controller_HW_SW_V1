...
#****************************************************
#
#    avr-mem.sh file is part of the CPP AVR build 
#     system it is called by the Makefile to calculate
#     the rough memory and flash space used on the device
#     by the compiled AVR elf file.
#
#    - Found online see header above.
...
"atmega328p") PROGMAX=${AVR32K}; DATAMAX=${AVR2K}; EEPROMMAX=${AVR1K};;
